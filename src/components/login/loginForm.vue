	...
	<section>
		<div class="login_bg">
			...
			<div class="login">
				...
				<div class="forgot_pw">
					...
					<div class="pop_bg" v-show="isForgotPop">
						<div class="email_pop" v-show="false">
							Verification email has been sent to <span>ajax연결</span>. Click
							the button in the email and sign up.
				...
				<!-- sns login -->
				<div class="sns_login">
					<p @click="goSnsLogin('google')">
						<img src="@/assets/img/icon_google.png" alt="googleSns" />Sign in
						with Google
					</p>
					<p @click="goSnsLogin('facebook')">
						<img src="@/assets/img/icon_facebook.png" alt="facebookSns" />Sign
						in with facebook
					</p>
					<p @click="goSnsLogin('twitter')">
						<img src="@/assets/img/icon_twitter.png" alt="twitterSns" />Sign in
						with Twitter
					</p>
				</div>
			</div>
